...
DEFAULT_INFO_PATH = project_root / 'advent/dataset/mapillary_list/info.json'
...
class MapillaryDataSet(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.load_instances:
            ...
            return image_array, np.squeeze(labels_array), np.array(size), str(image_path)
