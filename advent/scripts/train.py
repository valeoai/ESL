...
from advent.dataset.synthia import SYNDataSet
...
def main():
    ...
    if cfg.TARGET == 'Mapillary':
        target_dataset = MapillaryDataSet(root=cfg.DATA_DIRECTORY_TARGET,
                                            set=cfg.TRAIN.SET_TARGET,
                                            max_iters=cfg.TRAIN.MAX_ITERS * cfg.TRAIN.BATCH_SIZE_TARGET,
                                            crop_size=cfg.TRAIN.INPUT_SIZE_TARGET,
                                            mean=cfg.TRAIN.IMG_MEAN,
                                            label_folder=cfg.PSEUDO_LABEL_DIRECTORY_TARGET)
    else:
