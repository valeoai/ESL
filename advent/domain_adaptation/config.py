...
cfg.PSEUDO_LABEL_DIRECTORY_TARGET = ''
...
# ESL CONFIGS
cfg.ESL = EasyDict()
cfg.ESL.THRESHOLD = 0.1
cfg.ESL.RESTORE_FROM = ''
cfg.ESL.MODEL = 'DeepLabv2'
cfg.ESL.MULTI_LEVEL = True
cfg.ESL.IMG_MEAN = np.array((104.00698793, 116.66876762, 122.67891434), dtype=np.float32)
# Train sets
cfg.ESL.SET_TARGET = 'train'
cfg.ESL.BATCH_SIZE_TARGET = 1
cfg.ESL.INPUT_SIZE_TARGET = (1024, 512)
cfg.ESL.OUTPUT_SIZE_TARGET = (1024, 512)
cfg.ESL.INFO_TARGET = str(project_root / 'advent/dataset/cityscapes_list/info.json')
cfg.ESL.WAIT_MODEL = True
# Max batch size (for memory size purposes)
cfg.ESL.MAX_MEDIAN_BATCH = 3000
